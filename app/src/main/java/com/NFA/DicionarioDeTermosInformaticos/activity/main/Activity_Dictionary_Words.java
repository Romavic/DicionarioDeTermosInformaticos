...
import com.NFA.DicionarioDeTermosInformaticos.activity.Activity_Configuration;
import com.NFA.DicionarioDeTermosInformaticos.activity.Activity_Conversion;
import com.NFA.DicionarioDeTermosInformaticos.activity.Activity_Quiz;
import com.NFA.DicionarioDeTermosInformaticos.activity.Activity_Save_Words;
import com.NFA.DicionarioDeTermosInformaticos.adapters.Adapter_Dictionary_Words;
...
public class Activity_Dictionary_Words extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter_dictionary_words = new Adapter_Dictionary_Words(this, ListMeannig());
        recycler_view.setAdapter(adapter_dictionary_words);
    }

    private ArrayList<Model_Dictionary_Words> ListMeannig() {
        ArrayList<Model_Dictionary_Words> listMeaningDictionary = new ArrayList<>();
        Model_Dictionary_Words p;
    ...
    public void onBackPressed() {
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            new AlertDialog.Builder(this).setMessage(R.string.close_app)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                adapter_dictionary_words.filter(query);
                return true;
            }

            @Override
            public boolean onQueryTextChange(String newText) {
                adapter_dictionary_words.filter(newText);
                return true;
            }
        });
        return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_settings) {
            Intent intent = new Intent(Activity_Dictionary_Words.this, Activity_Configuration.class);
            startActivity(intent);

        } else if (id == R.id.nav_conversion) {
            Intent intent = new Intent(Activity_Dictionary_Words.this, Activity_Conversion.class);
            startActivity(intent);

        } else if (id == R.id.nav_save) {
            Intent intent = new Intent(Activity_Dictionary_Words.this, Activity_Save_Words.class);
            startActivity(intent);

        } else if (id == R.id.nav_quiz) {
            Intent intent = new Intent(Activity_Dictionary_Words.this, Activity_Quiz.class);
            startActivity(intent);
            ...
            try {
                ...
                startActivity(Intent.createChooser(intent, "Partilhar Apk"));
